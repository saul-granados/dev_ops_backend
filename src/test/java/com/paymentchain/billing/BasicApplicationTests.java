 ...
 * In Spring web applications, there are two contexts that gets initialized at server startup, each of which is configured and initialized differently. One is the â€œApplication Contextâ€� and the other is the â€œWeb Application Contextâ€œ
